...
<div class="tab-bar flex items-center bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
  <div class="flex items-center min-w-0">
    {#each tabs as tab, index (tab.id)}
      <div
        class="tab-item flex items-center px-4 py-2 border-r border-gray-200 dark:border-gray-700 cursor-pointer transition-colors duration-150 min-w-0 flex-shrink-0
          {tab.isActive ? 'bg-white dark:bg-gray-900 border-b-2 border-b-blue-500' : 'bg-gray-50 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700'}
      ...
      >
        ...
        {#if !tab.isPinned}
          <button
            class="ml-2 p-0.5 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors opacity-0 group-hover:opacity-100 tab-close-btn"
    ...
    <!-- 新建标签页按钮 -->
    <button
      class="px-3 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
